...
var browserDecoder = class BrowserDecoder {
...
const UTF8Decoder = browserDecoder;
...
var exports = md5$1.exports = function md5(utf8) {
...
class P2PLoader {
  constructor(streamManifestUrl, stream, requests, segmentStorage, config, eventTarget, onSegmentAnnouncement) {
    ...
    __publicField(this, "broadcastAnnouncement", (sendEmptyAnnouncement = false) => {
    ...
    __publicField(this, "sendSegmentsAnnouncement", (loaded, httpLoading) => {
    ...
    __publicField(this, "onSegmentRequested", async (peer, segmentExternalId, requestId, byteFrom) => {
...
class SegmentMemoryStorage {
  constructor() {
    __publicField(this, "userAgent", navigator.userAgent);
    __publicField(this, "segmentMemoryStorageLimit", 4 * 1024);
    __publicField(this, "currentStorageUsage", 0);
    __publicField(this, "cache", /* @__PURE__ */ new Map());
    __publicField(this, "logger");
    __publicField(this, "coreConfig");
    __publicField(this, "mainStreamConfig");
    __publicField(this, "secondaryStreamConfig");
    __publicField(this, "currentPlayback");
    __publicField(this, "lastRequestedSegment");
    __publicField(this, "segmentChangeCallback");
