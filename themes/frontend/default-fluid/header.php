...
<body class="bootstrap<?php echo $isDarkMode ? '-dark' : ' bg-light'; ?> mb-5">
    ...
    <div class="container-fluid rounded-bottom <?php echo $isDarkMode ? 'bg-dark' : 'bg-white'; ?> shadow">
        <header id="header">
            <nav class="navbar navbar-expand-lg container-fluid fixed-top shadow bg-custom navbar-dark">
