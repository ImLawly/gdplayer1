...
setEnvCustom('title', 'Terms of Service');
setEnvCustom('description', 'Terms of service that must be met between the website owner and the users of the services provided on this website.');
